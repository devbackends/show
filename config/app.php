...
return [
    ...
    */
    ...
    'debug_blacklist' => [
        '_ENV' => [
            ...
            'DB_PREFIX',
            'FILESYSTEM_DRIVER',
            'WAS_ACCESS_KEY_ID_PUBLIC',
            'WAS_SECRET_ACCESS_KEY_PUBLIC',
            'WAS_DEFAULT_REGION',
            'WAS_BUCKET_PUBLIC',
            'WAS_URL',
            'WAS_ACCESS_KEY_ID_PRIVATE',
            'WAS_SECRET_ACCESS_KEY_PRIVATE',
            'WAS_BUCKET_PRIVATE',
            'CLEARENT_API_URL',
            'CLEARENT_API_PRIVATE_KEY',
            'CLEARENT_API_PUBLIC_KEY',
            'CLEARENT_API_SOFTWARE_TYPE',
            'CLEARENT_API_SOFTWARE_VERSION',
            'CLEARENT_API_ON_PAYMENT',
            'CLEARENT_API_ON_RECURRING_PAYMENT',
            'CLEARENT_API_CARD_NUMBER',
            'CLEARENT_API_CARD_LAST_FOUR',
            'CLEARENT_API_CARD_EXP',
            'CLEARENT_API_CSC',
            'CLEARENT_API_CARD_TYPE',
            'CLEARENT_API_JWT_TOKEN',
            'PLATFORM_SMTP_HOST',
            'MAIL_MAILER',
            'MAIL_PORT',
            'MAIL_USERNAME',
            ...
            'MAIL_ENCRYPTION',
            'NUTSHELL_USER',
            'DISTRIBUTOR_IMPORT_PASSWORD',
            'DISTRIBUTOR_IMPORT_USER',
        ],
    ...
    */
    ...
    'providers' => [
        ...
        Mega\Phonelogin\Providers\PhoneloginServiceProvider::class,
        ...
        Webkul\Authorize\Providers\AuthorizeServiceProvider::class,
        Webkul\Braintree\Providers\BraintreeServiceProvider::class,
        Devvly\OnBoarding\Providers\OnBoardingServiceProvider::class,
        ...
        Devvly\Ffl\Providers\FflServiceProvider::class,
        Devvly\FflOnBoarding\Providers\FflOnBoardingServiceProvider::class,
        Devvly\Blog\Providers\BlogServiceProvider::class,
        ...
        Devvly\ClearentPayment\Providers\ClearentPaymentServiceProvider::class,
        Devvly\FluidPayment\Providers\FluidPaymentServiceProvider::class,
        Devvly\DistributorImport\Providers\DistributorImportServiceProvider::class,
        ...
        Devvly\ElasticSearch\Providers\ElasticSearchServiceProvider::class,
        Devvly\CustomBlocks\Providers\CustomBlocksServiceProvider::class,
        HansSchouten\LaravelPageBuilder\Providers\LaravelPageBuilderServiceProvider::class,
    ...
    */
    ...
    'defaultCompanyCode' => 'devvlystore',
    'defaultChannel' => 'devvlystore',
    'firearmFamilyCode' => 'firearm',
