...
class Requirement {
    ...
    public function composerInstall()
    {
        ...
        if (file_exists($autoLoadFile)) {
            ...
            $data['composer'] = 'Whalut has detected that the required composer dependencies are not installed.<br />Go to the root directory of Bagisto and run "composer install".';
        }
