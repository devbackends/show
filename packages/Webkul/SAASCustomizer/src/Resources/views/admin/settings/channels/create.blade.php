                    ...
                    <accordian :title="'{{ __('admin::app.settings.channels.general') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('hostname') ? 'has-error' : '']">
                                <label for="hostname" class="required">{{ __('admin::app.settings.channels.hostname') }}</label>
                                <input type="text" class="control" id="hostname" v-validate="'required'" name="hostname" value="{{ old('hostname') }}" placeholder="https://www.example.com" data-vv-as="&quot;{{ __('admin::app.settings.channels.hostname') }}&quot;"/>
                    ...
                    <accordian :title="'{{ __('admin::app.settings.channels.currencies-and-locales') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('locales[]') ? 'has-error' : '']">
                                ...
                                <select v-validate="'required'" class="control js-example-basic-multiple" id="locales" name="locales[]" data-vv-as="&quot;{{ __('admin::app.settings.channels.locales') }}&quot;" multiple>
                            ...
                            <div class="control-group" :class="[errors.has('currencies[]') ? 'has-error' : '']">
                                ...
                                <select v-validate="'required'" class="control js-example-basic-multiple" id="currencies" name="currencies[]" data-vv-as="&quot;{{ __('admin::app.settings.channels.currencies') }}&quot;" multiple>
                    ...
                    <accordian :title="'{{ __('admin::app.settings.channels.seo') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('seo_description') ? 'has-error' : '']">
                                ...
                                <textarea v-validate="'required'" class="control" id="seo_description" name="seo_description" data-vv-as="&quot;{{ __('admin::app.settings.channels.seo-description') }}&quot;">{{ old('seo_description') }}</textarea>
                            ...
                            <div class="control-group" :class="[errors.has('seo_keywords') ? 'has-error' : '']">
                                ...
                                <textarea v-validate="'required'" class="control" id="seo_keywords" name="seo_keywords" data-vv-as="&quot;{{ __('admin::app.settings.channels.seo-keywords') }}&quot;">{{ old('seo_keywords') }}</textarea>
