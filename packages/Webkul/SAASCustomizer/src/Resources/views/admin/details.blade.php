...
<div class="page-content">
        ...
        <div class="control-group" :class="[errors.has('first_name') ? 'has-error' : '']">
            ...
            <input type="text" class="control" name="first_name" v-validate="'required'" data-vv-as="&quot;{{ __('saas::app.admin.tenant.first-name') }}&quot;" value="{{ isset($details) ? $details['first_name'] : '' }}">
        ...
        <div class="control-group" :class="[errors.has('last_name') ? 'has-error' : '']">
            ...
            <input type="text" class="control" name="last_name" v-validate="'required'" data-vv-as="&quot;{{ __('saas::app.admin.tenant.last-name') }}&quot;" value="{{ isset($details) ? $details['last_name'] : '' }}">
        ...
        <div class="control-group" :class="[errors.has('email') ? 'has-error' : '']">
            ...
            <input type="text" class="control" name="email" v-validate="'required|email'" data-vv-as="&quot;{{ __('saas::app.admin.tenant.email') }}&quot;" value="{{ isset($details) ? $details['email'] : '' }}">
        ...
        <div class="control-group" :class="[errors.has('skype') ? 'has-error' : '']">
            ...
            <input type="text" class="control" name="skype" v-validate="'min:6|max:32'" data-vv-as="&quot;{{ __('saas::app.admin.tenant.skype') }}&quot;" value="{{ isset($details) ? $details['skype'] : '' }}">
        ...
        <div class="control-group" :class="[errors.has('phone') ? 'has-error' : '']">
            ...
            <input type="text" class="control" name="phone" v-validate="'required'" data-vv-as="&quot;{{ __('shop::app.customer.account.address.create.phone') }}&quot;" value="{{ isset($details) ? $details['phone'] : ''}}">
