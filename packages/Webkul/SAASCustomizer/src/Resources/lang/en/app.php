...
return [
    'super-user' => [
        ...
        'settings' => [
            ...
            'currencies' => [
                ...
                'create-success' => 'Success: Super admin currency created successfully.','update-success' => 'Success: Super admin currency updated successfully.',
    ...
    'tenant' => [
        ...
        'registration' => [
            ...
            'company-register-statement' => 'Start selling today with three simple steps',
            'email'                 => 'Email',
            'phone'                 => 'Phone',
            'username'              => 'Username',
            'password'              => 'Password',
            ...
            'give-store-name'       => 'Give a name to your store',
            'first-name'            => 'First Name',
            'last-name'             => 'Last Name',
            'store-name-notification' => "Don't worry, you can change your store name later or setup your own domain",
            'step-3'                => 'Step 3',
            'org-details'           => 'Organization Details',
            'org-name'              => 'Store name',
            'final-step'            => 'Final step!',
            'hear_about_us'         => 'Where did you hear about us?',
            'hear'                  => 'Hear',
