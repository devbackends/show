...
class MarketplaceUspsShippingServiceProvider extends ServiceProvider
{
    /**
     * Bootstrap services.
     *
    ...
    public function boot(Router $router)
    {
        ...
        $this->loadTranslationsFrom(__DIR__ . '/../Resources/lang', 'marketplace_usps');

        $this->loadViewsFrom(__DIR__ . '/../Resources/views', 'marketplace_usps');
