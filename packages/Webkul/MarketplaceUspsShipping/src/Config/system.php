...
return [
    [
        'key' => 'sales.carriers.mpusps',
        'name' => 'marketplace_usps::app.admin.system.mp-usps',
        'sort' => 3,
        'fields' => [
            [
                'name' => 'title',
                'title' => 'marketplace_usps::app.admin.system.title',
                'type' => 'text',
                'validation' => 'required',
                'channel_based' => false,
                'locale_based' => true
                ...
                'name' => 'description',
                'title' => 'marketplace_usps::app.admin.system.description',
                'type' => 'textarea',
                'channel_based' => false,
                'locale_based' => true
            ], [
                'name' => 'active',
                'title' => 'marketplace_usps::app.admin.system.status',
                'type' => 'select',
                'options' => [
                    [
                        'title' => 'Active',
                ...
                'name' => 'user_id',
                'title' => 'marketplace_usps::app.admin.system.user-id',
                'type' => 'text',
                'validation' => 'required',
                'channel_based' => true,
                'locale_based' => false
                ...
                'name' => 'password',
                'title' => 'marketplace_usps::app.admin.system.password',
                'type' => 'password',
                'validation' => 'required',
                'channel_based' => false,
                'locale_based' => true
                ...
                'name' => 'mode',
                'title' => 'marketplace_usps::app.admin.system.mode',
                'type' => 'select',
                'options' => [
                    [
                        'title' => 'Development',
                ...
                'name' => 'container',
                'title' => 'marketplace_usps::app.admin.system.container',
                'type' => 'select',
                'options' => [
                    [
                        'title' => 'Variable',
                ...
                'name' => 'machinable',
                'title' => 'marketplace_usps::app.admin.system.machinable',
                'type' => 'select',
                'options' => [
                    [
                        'title' => 'Yes',
                ...
                'name' => 'services',
                'title' => 'marketplace_usps::app.admin.system.allowed-methods',
                'type' => 'multiselect',
                'options' => [
                    [
                ...
                'name' => 'allow_seller',
                'title' => 'marketplace_usps::app.admin.system.allow-seller',
                'type' => 'select',
                'validation' => 'required',
                'options' => [
                    [
