...
class CustomerAddressRepository extends Repository
{
    ...
    public function create(array $data)
    {
        ...
        $checkAddressAlreadyExist = $this
            ->findWhere(['customer_id' => $data['customer_id'],'address1'=>$data['address1'],'country'=>$data['country'],'state'=>$data['state'],'city'=>$data['city'],'postcode'=>$data['postcode'] ])
            ->first();
        if (!isset($checkAddressAlreadyExist->id)) {
