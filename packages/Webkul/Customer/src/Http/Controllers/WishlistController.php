    ...
    */
    ...
    public function remove($productId)
    {
        ...
        foreach ($customerWishlistItems as $customerWishlistItem) {
            if ($productId == $customerWishlistItem->product_id) {
                $this->wishlistRepository->delete($customerWishlistItem->id);
    ...
    public function move($itemId)
    {
        ...
        try {
            $result = app(\Webkul\Checkout\Cart::class)->moveToCart($wishlistItem);
            ...
            if ($result) {
                ...
                return redirect()->route('shop.product.index', $wishlistItem->product->url_key);
            }
