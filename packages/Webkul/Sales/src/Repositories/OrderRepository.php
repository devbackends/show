...
class OrderRepository extends Repository
{
    ...
    public function create(array $data)
    {
        ...
        try {
            ...
            if (!session()->has('onlyWithoutShipping') || !request()->get('onlyWithoutShipping')) {
                ...
                if (isset($data['ffl_address'])) {
                    $order->addresses()->create($data['ffl_address']);
                }
            }
            ...
            foreach ($data['items'] as $item) {
                ...
                try {
                    $inventory=app('Webkul\Product\Repositories\ProductRepository')->getProductInventory($item['additional']['product_id'] ,$item['additional']['seller_info']['seller_id']);
                    $webhook=app('Webkul\Product\Repositories\ProductRepository')->sendWebhook($inventory,$item['additional']['seller_info']['seller_id'], $item['additional']['product_id']);
                }catch (\Exception $e){
                }
    ...
    public function saveNotes($order_id,$notes){
    ...
    public function getOrderByOrderItem($order_id){
