...
class CartShippingRate extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        if($this->carrier=='ups' or $this->carrier=='usps' or $this->carrier=='fedex' ){
            if(strpos(strtolower($this->method_description), strtolower($this->carrier)) !== false) {
                $this->method_title =  $this->method_description;
            }else{
                $this->method_title = strtoupper($this->carrier) . ' - ' . $this->method_description;
            }
        }
