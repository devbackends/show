...
class RefundController extends Controller
{
     ...
     *
     * @param  int  $orderId
     * @return \Illuminate\Contracts\Foundation\Application|\Illuminate\Contracts\View\Factory|\Illuminate\Http\View|\Illuminate\View\View
     */
    public function create($orderId)
    {
        ...
        $availableProcessors = array_map(function ($processorCode) {
            ...
            function ($processorClass) use ($order) {
                ...
                if (!$processorObject instanceof RefundProcessor) return false;
