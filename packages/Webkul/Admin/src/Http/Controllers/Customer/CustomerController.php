...
class CustomerController extends Controller
{
    ...
    public function update($id)
    {
        ...
        if(app('Webkul\Marketplace\Repositories\SellerRepository')->isSeller($id)){
            $seller_id=app('Webkul\Marketplace\Repositories\SellerRepository')->getVendorBySellerId($id);
            if(isset($data['verified_seller'])){
                if($data['verified_seller']==1){
                    app('Webkul\Marketplace\Repositories\SellerRepository')->update(['is_verified'=>1],$seller_id);
                }else{
                    app('Webkul\Marketplace\Repositories\SellerRepository')->update(['is_verified'=>0],$seller_id);
                }
            }else{
                app('Webkul\Marketplace\Repositories\SellerRepository')->update(['is_verified'=>0],$seller_id);
            }
        ...
        if ($seller) {
            ...
            app('Webkul\Marketplace\Repositories\SellerRepository')->update($sellerData, $seller->id);
