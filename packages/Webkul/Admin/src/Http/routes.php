...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::get('/products/sellerProductAdvancedSearch/{seller_id}', 'Webkul\Product\Http\Controllers\ProductController@sellerProductAdvancedSearch');
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::group(['middleware' => ['admin']], function () {
            ...
            Route::prefix('sales')->group(function () {
                ...
                //save order notes
                Route::post('/orders/save-notes/{id}', 'Webkul\Admin\Http\Controllers\Sales\OrderController@saveOrderNotes')
                      ->name('save.order.notes');
            ...
            Route::prefix('catalog')->group(function () {
                ...
                Route::get('/products/view/{id}', 'Webkul\Product\Http\Controllers\ProductController@view')->name('admin.catalog.products.view');
                ...
                Route::put('/attributes/edit/order/{id}', 'Webkul\Attribute\Http\Controllers\AttributeController@updateOptionSortOrder')->defaults('_config', [
                    'redirect' => 'admin.catalog.attributes.index'
                ])->name('admin.catalog.attributes.updateOptionSortOrder');
                ...
                Route::post('/families/edit/change-attribute-group', 'Webkul\Attribute\Http\Controllers\AttributeFamilyController@changeAttributeGroup')->defaults('_config', [
                ])->name('admin.catalog.attributes.change-attribute-group');

                Route::post('/families/edit/change-group-position', 'Webkul\Attribute\Http\Controllers\AttributeFamilyController@changeGroupPosition')->defaults('_config', [
                ])->name('admin.catalog.attributes.change-group-position');

                Route::put('/families/edit/position/{id}', 'Webkul\Attribute\Http\Controllers\AttributeFamilyController@updateAttrPosition')->defaults('_config', [
                    'redirect' => 'admin.catalog.families.index'
                ])->name('admin.catalog.families.updateAttrPosition');
            ...
            // Admin Store Front Settings Route
            Route::get('/subscribers/create', 'Webkul\Core\Http\Controllers\SubscriptionController@create')->defaults('_config', [
                'view' => 'admin::customers.subscribers.create'
            ])->name('admin.customers.subscribers.create');

            Route::post('/subscribers/create', 'Webkul\Core\Http\Controllers\SubscriptionController@store')->defaults('_config', [
                'redirect' => 'admin.customers.subscribers.index'
            ])->name('admin.customers.subscribers.store');
            ...
            Route::prefix('cms')->group(function () {
                ...
                Route::post('/duplicate/{id}', 'Webkul\CMS\Http\Controllers\Admin\PageController@duplicate')->defaults('_config', [
                    'redirect' => 'admin.cms.index'
                ])->name('admin.cms.duplicate');
    ...
    Route::post('/attributes/options/create', 'Webkul\Attribute\Http\Controllers\AttributeController@createAttributeOptions')->defaults('_config', [
    ])->name('admin.catalog.attributes.option.store');

    Route::get('/login-check-no-domain', 'Webkul\User\Http\Controllers\SessionController@loginCheckNoDomain')->defaults('_config', [
    ])->name('admin.login.login-check');
