            ...
            <div class="page-content">
                <div class="form-container">
                    ...
                    <div class="control-group" :class="[errors.has('taxrates[]') ? 'has-error' : '']">
                        ...
                        <select multiple="multiple" class="control js-example-basic-multiple" id="taxrates" name="taxrates[]" data-vv-as="&quot;{{ __('admin::app.settings.tax-categories.select-taxrates') }}&quot;" v-validate="'required'">
