                        ...
                        <accordian :title="'{{ __('admin::app.promotions.catalog-rules.rule-information') }}'" :active="true">
                            <div slot="body">
                                ...
                                <div class="control-group" :class="[errors.has('channels[]') ? 'has-error' : '']">
                                    ...
                                    <select class="control js-example-basic-multiple" id="channels" name="channels[]" v-validate="'required'" data-vv-as="&quot;{{ __('admin::app.promotions.catalog-rules.channels') }}&quot;" multiple="multiple">
                                ...
                                <div class="control-group" :class="[errors.has('customer_groups[]') ? 'has-error' : '']">
                                    ...
                                    <select class="control js-example-basic-multiple" id="customer_groups" name="customer_groups[]" v-validate="'required'" data-vv-as="&quot;{{ __('admin::app.promotions.catalog-rules.customer-groups') }}&quot;" multiple="multiple">
                ...
                <div v-if="matchedAttribute">
                    ...
                    <div v-else>
                        ...
                        <div class="control-group" v-if="matchedAttribute.type == 'multiselect' || matchedAttribute.type == 'checkbox'">
                            <select :name="['conditions[' + index + '][value][]']" class="control js-example-basic-multiple" v-model="condition.value" multiple>
                                <option v-for='option in matchedAttribute.options' :value="option.id">
                                    @{{ option.admin_name }}
                                </option>
                            </select>
