    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h3>{{ __('admin::app.settings.exchange_rates.title') }}</h3>
            </div>

            <div class="page-action">
                <a href="{{ route('admin.exchange_rates.create') }}" class="btn btn-primary">
                ...
                {{-- <a href="{{ route('admin.exchange_rates.update-rates', $defaultService) }}" class="btn btn-primary">
