    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h3>{{ __('admin::app.customers.addresses.title', ['customer_name' => $customer->first_name . ' ' . $customer->last_name]) }}</h3>
            </div>

            <div class="page-action">
                <a href="{{ route('admin.customer.addresses.create', ['id' => $customer->id]) }}" class="btn btn-primary">
