                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            ...
                                                            $sourceQty = $product->type == 'bundle' ? $item->qty_ordered : $product->productFlat->quantity;
                                                        @endphp
                                                    ...
                                                    <td>
                                                        @php
                                                            $inputName = "shipment[items][$item->id]";
                                                        @endphp

                                                        <div class="control-group" :class="[errors.has('{{ $inputName }}') ? 'has-error' : '']">

                                                            <input type="text" v-validate="'required|numeric|min_value:0|max_value:{{$sourceQty}}'" class="control" id="{{ $inputName }}" name="{{ $inputName }}" value="{{$item->qty_to_ship}}" data-vv-as="&quot;{{ __('admin::app.sales.shipments.qty-to-ship') }}&quot;" />
