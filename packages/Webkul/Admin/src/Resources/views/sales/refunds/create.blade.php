            ...
            <div class="page-content">
                <div class="sale-container">
                    ...
                    <div class="control-group">
                        ...
                        <select v-validate="'required'" class="control" name="refund_processor" id="refund_processor" data-vv-as="&quot;Refund Processor&quot;">
                            <option value="manual" {{empty($availableProcessors) ? 'selected' : ''}}>Manual</option>

                            @foreach ($availableProcessors as $availableProcessor)
                                <option value="{{ $availableProcessor['code'] }}">{{ $availableProcessor['title'] }}</option>
                            @endforeach
    ...
    <script type="text/x-template" id="refund-items-template">
        <div>
            ...
            <div style="width: 100%; display: inline-block">
                <button type="button" class="btn btn-primary" style="float: right" @click="updateQty">
