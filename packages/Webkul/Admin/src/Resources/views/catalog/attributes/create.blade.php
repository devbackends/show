                    ...
                    <accordian :title="'{{ __('admin::app.catalog.attributes.general') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group">
                                ...
                                <select  class="control js-example-basic-multiple" id="type" name="type">
                    ...
                    <accordian :title="'{{ __('admin::app.catalog.attributes.label') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('description') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" id="description" name="description" value="{{ old('description') }}" data-vv-as="&quot;Description&quot;"/>
...
@push('scripts')
    <script type="text/x-template" id="options-template">
        <div>
            ...
            <button type="button" class="btn btn-primary mt-20" id="add-option-btn" @click="addOptionRow(false)">
