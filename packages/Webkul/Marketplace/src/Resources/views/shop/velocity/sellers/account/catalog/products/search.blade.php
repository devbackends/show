...
@push('scripts')
    ...
    <script type="text/x-template" id="product-search-template">
        ...
        <div class="control-group">
            ...
            <input type="text" class="form-style dropdown-toggle" name="search" placeholder="{{ __('marketplace::app.shop.sellers.account.catalog.products.search-term') }}" autocomplete="off" v-model.lazy="term" v-debounce="500"/>
                            ...
                            <table>
                                <tbody>
                                    <tr v-for='(product, index) in products'>
                                        ...
                                        <td class="last">
                                            <a :href="['{{ route('marketplace.account.products.assign') }}/' + product.id ]" class="btn btn-primary btn-sm theme-btn">
                                                Sell yours
                                            </a>
                                        </td>
                                    </tr>
