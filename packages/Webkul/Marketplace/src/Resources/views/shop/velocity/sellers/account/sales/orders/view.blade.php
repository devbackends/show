        ...
        <div class="account-head">
            ...
            <div class="account-action">
                @if (core()->getConfigData('marketplace.settings.general.can_cancel_order') && $sellerOrder->canCancel())
                    <a href="{{ route('marketplace.account.orders.cancel', $sellerOrder->order_id) }}" class="btn btn-lg btn-primary theme-btn" v-alert:message="'{{ __('admin::app.sales.orders.cancel-confirm-msg') }}'">
                ...
                @if (core()->getConfigData('marketplace.settings.general.can_create_invoice') && $sellerOrder->canInvoice())
                    <a href="{{ route('marketplace.account.invoices.create', $sellerOrder->order_id) }}" class="btn btn-lg btn-primary theme-btn">
                ...
                @if (core()->getConfigData('marketplace.settings.general.can_create_shipment') && $sellerOrder->canShip())
                    <a href="{{ route('marketplace.account.shipments.create', $sellerOrder->order_id) }}" class="btn btn-lg btn-primary theme-btn">
                                        ...
                                        <table>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $sellerShipment->shipment->carrier_title }}</td>
                                                </tr>
