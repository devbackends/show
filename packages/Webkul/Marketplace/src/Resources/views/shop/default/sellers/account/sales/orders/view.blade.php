...
@section('content')
    ...
    <div class="account-layout">
        ...
        <div class="account-head">
            <h1 class="h3">{{ __('marketplace::app.shop.sellers.account.sales.orders.view-title', ['order_id' => $sellerOrder->order_id]) }}</h1>
            <div class="account-action">
                @if (core()->getConfigData('marketplace.settings.general.can_cancel_order') && $sellerOrder->canCancel())
                    <a href="{{ route('marketplace.account.orders.cancel', $sellerOrder->order_id) }}" class="btn btn-primary" v-alert:message="'{{ __('admin::app.sales.orders.cancel-confirm-msg') }}'">
                ...
                @if (core()->getConfigData('marketplace.settings.general.can_create_invoice') && $sellerOrder->canInvoice())
                    <a href="{{ route('marketplace.account.invoices.create', $sellerOrder->order_id) }}" class="btn btn-primary">
                ...
                @if (core()->getConfigData('marketplace.settings.general.can_create_shipment') && $sellerOrder->canShip())
                    <a href="{{ route('marketplace.account.shipments.create', $sellerOrder->order_id) }}" class="btn btn-primary">
