                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                @if($sellerInvoice->invoice->order->shipping_address)
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <p>{{ $sellerInvoice->invoice->order->billing_address->city }}, {{ $sellerInvoice->invoice->order->billing_address->state }} {{ $sellerInvoice->invoice->order->billing_address->postcode }}</p>
                                    <p>{{ core()->country_name($sellerInvoice->invoice->order->billing_address->country) }}</p>
                                ...
                                @if($sellerInvoice->invoice->order->shipping_address)
                                    <td>
                                        ...
                                        <p>{{ $sellerInvoice->invoice->order->shipping_address->city }}, {{ $sellerInvoice->invoice->order->shipping_address->state }} {{ $sellerInvoice->invoice->order->shipping_address->postcode }}</p>
                                        <p>{{ core()->country_name($sellerInvoice->invoice->order->shipping_address->country) }}</p>
                        ...
                        <tbody>
                            ...
                            @foreach ($sellerInvoice->items as $sellerInvoiceItem)
                                ...
                                <tr>
                                    ...
                                    @if (isset($baseInvoiceItem->additional['attributes']))
                                        <div class="item-options">

                                            @foreach ($baseInvoiceItem->additional['attributes'] as $attribute)
