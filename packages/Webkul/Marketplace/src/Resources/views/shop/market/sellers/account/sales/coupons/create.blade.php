...
@push('scripts')
    ...
    <script type="text/x-template" id="cart-rule-template">
        <div class="settings-page">
            <form method="POST" action="{{ route('marketplace.account.coupons.store') }}" @submit.prevent="onSubmit">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group" :class="[errors.has('name') ? 'has-error' : '']">
                                            ...
                                            <input v-validate="'required'" class="form-control" id="name" name="name" data-vv-as="&quot;{{ __('admin::app.promotions.cart-rules.name') }}&quot;" value="{{ old('name') }}"/>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" id="status" class="form-control" name="status" value="1" {{ old('status') ? 'checked' : '' }}>
                                        ...
                                        <div v-if="parseInt(coupon_type)">
                                            ...
                                            <div v-if="! parseInt(use_auto_generation)">
                                                <div class="form-group" :class="[errors.has('coupon_code') ? 'has-error' : '']">
                                                    ...
                                                    <input v-validate="'required'" class="form-control" id="coupon_code" name="coupon_code" data-vv-as="&quot;{{ __('admin::app.promotions.cart-rules.coupon-code') }}&quot;" value="{{ old('coupon_code') }}"/>
                                                    <span class="control-error" v-if="errors.has('coupon_code')">@{{ errors.first('coupon_code') }}</span>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label for="uses_per_coupon" class="form-label">{{ __('admin::app.promotions.cart-rules.uses-per-coupon') }}</label>
                                                <input class="form-control" id="uses_per_coupon" name="uses_per_coupon" value="{{ old('uses_per_coupon') }}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="usage_per_customer" name="usage_per_customer" value="{{ old('usage_per_customer') }}"/>
                                            <span class="control-info">{{ __('admin::app.promotions.cart-rules.uses-per-customer-control-info') }}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group date">
                                            <label for="starts_from" class="form-label">{{ __('admin::app.promotions.cart-rules.from') }}</label>
                                            <datetime>
                                                <input type="text" name="starts_from" class="form-control" value="{{ old('starts_from') }}"/>
                                            </datetime>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group date">
                                            <label for="ends_till" class="form-label">{{ __('admin::app.promotions.cart-rules.to') }}</label>
                                            <datetime>
                                                <input type="text" name="ends_till" class="form-control" value="{{ old('ends_till') }}"/>
                                            </datetime>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="sort_order" name="sort_order" value="{{ old('sort_order') ?? 0 }}"/>
                                        </div>
                                    </div>
                                </div>
...
{{--                                                <option value="buy_x_get_y" {{ old('action_type') == 'buy_x_get_y' ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group" :class="[errors.has('discount_amount') ? 'has-error' : '']">
                                            ...
                                            <input v-validate="'required'" class="form-control" id="discount_amount" name="discount_amount" data-vv-as="&quot;{{ __('admin::app.promotions.cart-rules.discount-amount') }}&quot;" value="{{ old('discount_amount') ?? 0 }}"/>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="discount_quantity" name="discount_quantity" value="{{ old('discount_quantity') ?? 0 }}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="discount_step" class="form-label">{{ __('admin::app.promotions.cart-rules.discount-step') }}</label>
                                            <input class="form-control" id="discount_step" name="discount_step" value="{{ old('discount_step') ?? 0 }}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
        ...
        <tr>
            ...
            <td class="operator">
                <div class="form-group" v-if="matchedAttribute">
                    <select :name="['conditions[' + index + '][operator]']" class="form-control" v-model="condition.operator">
