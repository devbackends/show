...
@push('scripts')
    ...
    <script type="text/x-template" id="cart-rule-template">
        <div class="settings-page">
            <form method="POST" action="{{ route('marketplace.account.coupons.update', $cartRule->id) }}" @submit.prevent="onSubmit">
                <div class="settings-page__header align-items-center">
                    <div class="settings-page__header-title">
                        <h3>
                            <i class="icon angle-left-icon back-link" @click="redirectBack('{{ route('marketplace.account.coupons.index') }}')"></i>
                            Edit Coupon
                        </h3>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="create-product__box">
                                ...
                                <p class="create-product__box-title">General</p>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group" :class="[errors.has('name') ? 'has-error' : '']">
                                            <label for="name" class="form-label-required">{{ __('admin::app.promotions.cart-rules.name') }}</label>
                                            <input v-validate="'required'" class="form-control" id="name" name="name" data-vv-as="&quot;{{ __('admin::app.promotions.cart-rules.name') }}&quot;" value="{{ old('name') ?: $cartRule->name }}"/>
                                            <span class="control-error" v-if="errors.has('name')">@{{ errors.first('name') }}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="description" class="form-label">{{ __('admin::app.promotions.cart-rules.description') }}</label>
                                            <textarea class="form-control" id="description" name="description">{{ old('description') ?: $cartRule->description }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="status" class="form-label">{{ __('admin::app.promotions.cart-rules.status') }}</label>

                                            <label class="switch">
                                                <input class="form-control" type="checkbox" id="status" name="status" value="{{ $cartRule->status }}" {{ $cartRule->status ? 'checked' : '' }}>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group" :class="[errors.has('channels[]') ? 'has-error' : '']">
                                            <label for="channels" class="form-label-required">{{ __('admin::app.promotions.cart-rules.channels') }}</label>
                                            <?php $selectedOptionIds = old('channels') ?: $cartRule->channels->pluck('id')->toArray() ?>
                                            <select class="form-control" id="channels" name="channels[]" v-validate="'required'" data-vv-as="&quot;{{ __('admin::app.promotions.cart-rules.channels') }}&quot;" multiple="multiple">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group" :class="[errors.has('customer_groups[]') ? 'has-error' : '']">
                                            <label for="customer_groups" class="form-label-required">{{ __('admin::app.promotions.cart-rules.customer-groups') }}</label>
                                            <?php $selectedOptionIds = old('customer_groups') ?: $cartRule->customer_groups->pluck('id')->toArray() ?>
                                            <select class="form-control" id="customer_groups" name="customer_groups[]" v-validate="'required'" data-vv-as="&quot;{{ __('admin::app.promotions.cart-rules.customer-groups') }}&quot;" multiple="multiple">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group" :class="[errors.has('coupon_type') ? 'has-error' : '']">
                                            <label for="coupon_type" class="form-label-required">{{ __('admin::app.promotions.cart-rules.coupon-type') }}</label>
                                            <select class="form-control" id="coupon_type" name="coupon_type" v-model="coupon_type" v-validate="'required'" data-vv-as="&quot;{{ __('admin::app.promotions.cart-rules.coupon-type') }}&quot;">
                                    ...
                                    <div class="col-md-12">
                                        <div v-if="parseInt(coupon_type)">
                                            <div class="form-group" :class="[errors.has('use_auto_generation') ? 'has-error' : '']">
                                                <label for="use_auto_generation" class="form-label-required">{{ __('admin::app.promotions.cart-rules.auto-generate-coupon') }}</label>
                                                <select class="form-control" id="use_auto_generation" name="use_auto_generation" v-model="use_auto_generation" v-validate="'required'" data-vv-as="&quot;{{ __('admin::app.promotions.cart-rules.auto-generate-coupon') }}&quot;">
                                            ...
                                            <div v-if="! parseInt(use_auto_generation)">
                                                <div class="form-group" :class="[errors.has('coupon_code') ? 'has-error' : '']">
                                                    <label for="coupon_code" class="form-label-required">{{ __('admin::app.promotions.cart-rules.coupon-code') }}</label>
                                                    <input v-validate="'required'" class="form-control" id="coupon_code" name="coupon_code" data-vv-as="&quot;{{ __('admin::app.promotions.cart-rules.coupon-code') }}&quot;" value="{{ old('coupon_code') ?: $cartRule->coupon_code }}"/>
                                                    <span class="control-error" v-if="errors.has('coupon_code')">@{{ errors.first('coupon_code') }}</span>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label for="uses_per_coupon" class="form-label-control">{{ __('admin::app.promotions.cart-rules.uses-per-coupon') }}</label>
                                                <input class="form-control" id="uses_per_coupon" name="uses_per_coupon" value="{{ old('uses_per_coupon') ?: $cartRule->uses_per_coupon }}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="usage_per_customer" class="form-label">{{ __('admin::app.promotions.cart-rules.uses-per-customer') }}</label>
                                            <input class="form-control" id="usage_per_customer" name="usage_per_customer" value="{{ old('usage_per_customer') ?: $cartRule->usage_per_customer }}"/>
                                            <span class="control-info">{{ __('admin::app.promotions.cart-rules.uses-per-customer-control-info') }}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group date">
                                            <label for="starts_from" vlass="form-label">{{ __('admin::app.promotions.cart-rules.from') }}</label>
                                            <datetime>
                                                <input type="text" name="starts_from" class="form-control" value="{{ old('starts_from') ?: $cartRule->starts_from }}"/>
                                            </datetime>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group date">
                                            <label for="ends_till" vlass="form-label">{{ __('admin::app.promotions.cart-rules.to') }}</label>
                                            <datetime>
                                                <input type="text" name="ends_till" class="form-control" value="{{ old('ends_till') ?: $cartRule->ends_till }}"/>
                                            </datetime>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="sort_order" class="form-label">{{ __('admin::app.promotions.cart-rules.priority') }}</label>
                                            <input type="text" class="form-control" id="sort_order" name="sort_order" value="{{ $cartRule->sort_order }}" {{ $cartRule->sort_order ? 'checked' : '' }}/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="create-product__box">
                                <span class="create-product__box-spy-anchor"></span>
                                <p class="create-product__box-title">Conditions</p>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="condition_type" class="form-label">{{ __('admin::app.promotions.cart-rules.condition-type') }}</label>

                                            <select class="form-control" id="condition_type" name="condition_type" v-model="condition_type">
                                    ...
                                    <div class="col-md-12">
                                        <button type="button" class="btn btn-primary" style="margin-top: 20px;" @click="addCondition">
                            ...
                            <div class="create-product__box">
                                <span class="create-product__box-spy-anchor"></span>
                                <p class="create-product__box-title">Actions</p>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group" :class="[errors.has('action_type') ? 'has-error' : '']">
                                            <label for="action_type" class="form-label-required">{{ __('admin::app.promotions.cart-rules.action-type') }}</label>
                                            <?php $selectedOption = old('action_type') ?: $cartRule->action_type ?>
                                            <select class="form-control" id="action_type" name="action_type" v-validate="'required'" v-model="action_type" data-vv-as="&quot;{{ __('admin::app.promotions.cart-rules.action-type') }}&quot;">
...
{{--                                                <option value="buy_x_get_y" {{ $selectedOption == 'buy_x_get_y' ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group" :class="[errors.has('discount_amount') ? 'has-error' : '']">
                                            <label for="discount_amount" class="form-label-required">{{ __('admin::app.promotions.cart-rules.discount-amount') }}</label>
                                            <input v-validate="'required'" class="form-control" id="discount_amount" name="discount_amount" data-vv-as="&quot;{{ __('admin::app.promotions.cart-rules.discount-amount') }}&quot;" value="{{ old('discount_amount') ?: $cartRule->discount_amount }}"/>
                                            <span class="control-error" v-if="errors.has('discount_amount')">@{{ errors.first('discount_amount') }}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="discount_quantity" class="form-label">{{ __('admin::app.promotions.cart-rules.discount-quantity') }}</label>
                                            <input class="form-control" id="discount_quantity" name="discount_quantity" value="{{ old('discount_quantity') ?: $cartRule->discount_quantity }}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="discount_step" class="form-label">{{ __('admin::app.promotions.cart-rules.discount-step') }}</label>
                                            <input class="form-control" id="discount_step" name="discount_step" value="{{ old('discount_step') ?: $cartRule->discount_step }}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="apply_to_shipping" class="form-label">{{ __('admin::app.promotions.cart-rules.apply-to-shipping') }}</label>
                                            <?php $selectedOption = old('apply_to_shipping') ?: $cartRule->apply_to_shipping ?>
                                            <select class="form-control" id="apply_to_shipping" name="apply_to_shipping" :disabled="action_type == 'cart_fixed'">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="free_shipping" class="form-label">{{ __('admin::app.promotions.cart-rules.free-shipping') }}</label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="end_other_rules" class="form-label">{{ __('admin::app.promotions.cart-rules.end-other-rules') }}</label>
                                            <?php $selectedOption = old('end_other_rules') ?: $cartRule->end_other_rules ?>
                                            <select class="form-control" id="end_other_rules" name="end_other_rules">
                                                <option value="0" {{ ! $selectedOption ? 'selected' : '' }}>
                                                    {{ __('admin::app.promotions.cart-rules.no') }}
                                                </option>
    ...
    <script type="text/x-template" id="cart-rule-condition-item-template">
        <tr>
            <td class="attribute">
                <div class="form-group">
                    <select :name="['conditions[' + index + '][attribute]']" class="form-control" v-model="condition.attribute">
            ...
            <td class="operator">
                <div class="form-group" v-if="matchedAttribute">
                    <select class="form-control" :name="['conditions[' + index + '][operator]']" class="control" v-model="condition.operator">
                ...
                <div v-if="matchedAttribute">
                    ...
                    <div v-else>
                        <div class="form-group" v-if="matchedAttribute.type == 'text' || matchedAttribute.type == 'price' || matchedAttribute.type == 'decimal' || matchedAttribute.type == 'integer'">
                            <input class="form-control" :name="['conditions[' + index + '][value]']" v-model="condition.value"/>
                        </div>
                        ...
                        <div class="form-group" v-if="matchedAttribute.type == 'boolean'">
                            <select :name="['conditions[' + index + '][value]']" class="form-control" v-model="condition.value">
                                <option value="1">{{ __('admin::app.promotions.cart-rules.yes') }}</option>
                                <option value="0">{{ __('admin::app.promotions.cart-rules.no') }}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group" v-if="matchedAttribute.type == 'select' || matchedAttribute.type == 'radio'">
                            <select :name="['conditions[' + index + '][value]']" class="form-control" v-model="condition.value" v-if="matchedAttribute.key != 'cart|state'">
                                <option v-for='option in matchedAttribute.options' :value="option.id">
                                    @{{ option.admin_name }}
                                </option>
                            </select>

                            <select :name="['conditions[' + index + '][value]']" class="form-control" v-model="condition.value" v-else>
                        ...
                        <div class="form-group" v-if="matchedAttribute.type == 'multiselect' || matchedAttribute.type == 'checkbox'">
                            <select :name="['conditions[' + index + '][value][]']" class="form-control" v-model="condition.value" multiple>
                                <option v-for='option in matchedAttribute.options' :value="option.id">
                                    @{{ option.admin_name }}
                                </option>
                            </select>
    ...
    <script type="text/x-template" id="create-coupon-form-template">
        <div class="">
            <form method="POST" data-vv-scope="create-coupun-form" @submit.prevent="generateCopuns('create-coupun-form')">
                ...
                <div class="form-group" :class="[errors.has('create-coupun-form.coupon_qty') ? 'has-error' : '']">
                    <label for="coupon_qty" class="form-label-required">{{ __('admin::app.promotions.cart-rules.coupon-qty') }}</label>
                    <input v-validate="'required|min_value:1'" class="form-control" id="coupon_qty" name="coupon_qty" v-model="coupon_format.coupon_qty" data-vv-as="&quot;{{ __('admin::app.promotions.cart-rules.coupon-qty') }}&quot;"/>
                    <span class="control-error" v-if="errors.has('create-coupun-form.coupon_qty')">
                        @{{ errors.first('create-coupun-form.coupon_qty') }}
                    </span>
                </div>

                <div class="form-group" :class="[errors.has('create-coupun-form.code_length') ? 'has-error' : '']">
                    <label for="code_length" class="form-label-required">{{ __('admin::app.promotions.cart-rules.code-length') }}</label>
                    <input v-validate="'required|min_value:10'" class="form-control" id="code_length" name="code_length" v-model="coupon_format.code_length" data-vv-as="&quot;{{ __('admin::app.promotions.cart-rules.code-length') }}&quot;"/>
                ...
                <div class="form-group" :class="[errors.has('create-coupun-form.code_format') ? 'has-error' : '']">
                    <label for="code_format" class="form-label-required">{{ __('admin::app.promotions.cart-rules.code-format') }}</label>
                    <select class="form-control" id="code_format" name="code_format" v-model="coupon_format.code_format" v-validate="'required'" data-vv-as="&quot;{{ __('admin::app.promotions.cart-rules.code-format') }}&quot;">
                ...
                <div class="form-group">
                    <label for="code_prefix" class="form-label">{{ __('admin::app.promotions.cart-rules.code-prefix') }}</label>
                    <input class="form-control" id="code_prefix" name="code_prefix" v-model="coupon_format.code_prefix"/>
                </div>

                <div class="form-group">
                    <label for="code_suffix" class="form-label">{{ __('admin::app.promotions.cart-rules.code-suffix') }}</label>
                    <input class="form-control" id="code_suffix" name="code_suffix" v-model="coupon_format.code_suffix"/>
                </div>
