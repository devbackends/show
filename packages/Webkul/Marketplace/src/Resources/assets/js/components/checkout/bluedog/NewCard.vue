<template>
    <div class="modal fade credit-card-modal" id="newBlueDogCardPopup" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="bluedog-form" class="mb-3"></div>
    ...
    async mounted() {
        ...
        if (response.data.status) {
            this.tokenizer = new Tokenizer({
                ...
                container: document.querySelector('#bluedog-form'),
                submission: (res) => {
                    if (res.status === 'success') {
                        $('#newBlueDogCardPopup').modal('toggle');
                        this.$emit('submit', {
                            token: res.token,
