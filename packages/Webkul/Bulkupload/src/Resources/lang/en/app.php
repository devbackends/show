...
return [
    'shop' => [
        'bulk-upload' => [
            'set-seller' => 'Set Customer',
            'bulk-upload' => 'Bulk Product Upload',
            'bulk-upload-dataflow-profile' => 'Bulk Upload  Profile',
            'upload-files' => 'Upload Files',
            'run-profile' => 'Run Profile',
            'download-sample' => 'Download Sample',
            'attribute-set' => 'Attribute Set',
            'data-flow-profile' => 'Upload Profile',
            'file' => 'CSV/XLS file',
        ...
        'message' => [
            ...
            'data-profile-not-selected' => 'Upload Profile not selected',
        ...
        'profile' => [
            ...
            'seller-grid' => 'Customer Profile Grid'
        ],
    ...
    'admin' => [
        'bulk-upload' => [
            'set-seller' => 'Set Customer',
            'bulk-upload' => 'Bulk Product Upload',
            'bulk-upload-dataflow-profile' => 'Upload Profile',
            'upload-files' => 'Upload Files',
            'run-profile' => 'Run Profile',
            'download-sample' => 'Download Sample',
            'attribute-set' => 'Attribute Set',
