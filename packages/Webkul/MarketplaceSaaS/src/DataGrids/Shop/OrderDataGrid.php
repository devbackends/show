...
namespace Webkul\MarketplaceSaaS\DataGrids\Shop;
...
class OrderDataGrid extends DataGrid
{
    ...
    public function prepareQueryBuilder()
    {
        ...
        $queryBuilder = DB::table('marketplace_orders')
                ...
                ->select('orders.increment_id as id', 'marketplace_orders.order_id', 'marketplace_orders.base_grand_total', 'marketplace_orders.grand_total', 'marketplace_orders.created_at', 'channel_name', 'marketplace_orders.status', 'orders.order_currency_code')
