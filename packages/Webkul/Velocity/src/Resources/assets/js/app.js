...
window.BootstrapSass = require("bootstrap");
...
Vue.component('new-products-t', require('./UI/components/new-products-t'));
Vue.component('featured-products-t', require('./UI/components/featured-products-t'));
