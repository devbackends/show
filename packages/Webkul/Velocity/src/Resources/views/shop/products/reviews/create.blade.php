        ...
        <section class="row review-page-container">
            ...
            <div class="col-12 col-md-5">
                ...
                <form
                    ...
                    <div class="mb-3" :class="`${errors.has('rating') ? 'has-error' : ''}`">
                    ...
                    <div class="mb-3" :class="`${errors.has('title') ? 'has-error' : ''}`">
                        <label for="title" class="required">
                    ...
                    @if (core()->getConfigData('catalog.products.review.guest_review') && ! auth()->guard('customer')->user())
                        <div class="mb-3" :class="`${errors.has('name') ? 'has-error' : ''}`">
                            <label for="title" class="required">
                    ...
                    <div class="mb-3" :class="`${errors.has('comment') ? 'has-error' : ''}`">
