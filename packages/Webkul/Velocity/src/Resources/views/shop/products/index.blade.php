...
@push('scripts')
    ...
    <script type="text/x-template" id="category-template">
        <section class="col-12 velocity-divide-page category-page-wrapper" style="display:flex;">
            ...
            <div class="category-container col-lg-10">
                ...
                <div
                    ...
                    @if ($isDisplayMode)
                        <shimmer-component v-if="isLoading && !isMobile()" shimmer-count="3"></shimmer-component>
