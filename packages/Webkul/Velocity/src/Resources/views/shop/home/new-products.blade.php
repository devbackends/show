            ...
            <div class="container py-5">
                ...
                <template v-else-if="newProducts.length > 0">
                    ...
                    @if ($showRecentlyViewed)
                        ...
                        <div class="row ltr">
                            <div class="col-8 carousel-products vc-full-screen with-recent-viewed" v-if="!isMobileView">
                                <carousel-component
                                        :slides-per-page="4"
                            ...
                            <div class="col-12 carousel-products vc-small-screen" v-else>
                                <carousel-component
