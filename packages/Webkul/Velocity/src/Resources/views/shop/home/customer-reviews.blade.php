                            ...
                            <div class="customer-info">
                                ...
                                <div>
                                    ...
                                    <div class="product-info fs16">
                                        <span>{{ __('velocity::app.products.reviewed') }}- <a class="remove-decoration link-color" href="{{ route('shop.product.index', $review->product->url_key) }}">{{$review->product->name}}</a></span>
                                    </div>
                                </div>
                            </div>
