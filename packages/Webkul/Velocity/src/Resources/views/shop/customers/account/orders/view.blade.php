    ...
    <div class="account-content">
        <div class="account-layout">
            <div class="account-head">
                ...
                <span class="paragraph-big bold link-color"> {{ __('shop::app.customer.account.order.index.title') }} /</span>
                <span class="paragraph-big bold">{{ __('shop::app.customer.account.order.view.page-tile', ['order_id' => $order->increment_id]) }}</span>
                <span class="paragraph">Placced on  {{ core()->formatDate($order->created_at, 'd M Y') }}</span>
            ...
            <div class="sale-container">
                <tabs>
                    <tab name="{{ __('shop::app.customer.account.order.view.info') }}" :selected="true">
                        ...
                        <div class="sale-section">
                            <div class="section-title paragraph black bold">
                ...
                <div class="sale-section">
                    <div class="section-content" style="border-bottom: 0">
                        <div class="order-box-container">
                            <div class="box">
                                <div class="box-title paragraph black bold uppercase">
                                    {{ __('shop::app.customer.account.order.view.billing-address') }}
                                </div>

                                <div class="box-content  paragraph black">
