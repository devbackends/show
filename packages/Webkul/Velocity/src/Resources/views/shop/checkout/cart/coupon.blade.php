        ...
        <div class="coupon-container">
            <div class="discount-control">
                <form class="custom-form" method="post" @submit.prevent="applyCoupon">
                    <div  style="height:40px;" class="control-group" :class="[error_message ? 'has-error' : '']">
                        ...
                        <button id="apply_coupon_button" class="btn btn-outline-primary" :disabled="disable_button">{{ __('shop::app.checkout.onepage.apply-coupon') }}</button>
                    </div>
                    <div style="height:20px;" class="control-error">@{{ error_message }}</div>
                </form>
            </div>
