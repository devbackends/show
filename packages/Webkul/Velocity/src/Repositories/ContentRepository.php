    ...
    */
    ...
    public function getAllContents()
    {
        ...
        $contentCollection = $query
            ->select('velocity_contents.content_type', 'velocity_contents_translations.link_target','velocity_contents_translations.title','velocity_contents_translations.page_link','velocity_contents_translations.page_link')
