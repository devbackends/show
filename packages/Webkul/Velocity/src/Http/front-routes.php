...
Route::group(['middleware' => ['web', 'locale', 'theme', 'currency']], function () {
    Route::namespace('Webkul\Velocity\Http\Controllers\Shop')->group(function () {
        ...
        Route::get('/autocomplete-product', 'ShopController@autocompleteProduct')
            ->name('velocity.autocomplete-product');
        ...
        Route::get('/attributes', 'ShopController@fetchAttributes')
            ->name('velocity.attributiest');
        Route::get('/attribute/{id}', 'ShopController@fetchAttribute')
            ->name('velocity.attributiest');
        Route::get('/attribute/{id}/options', 'ShopController@fetchAttributeOptions')
            ->name('velocity.attributiest');
