                            ...
                            @foreach ($cart->items as $key => $item)
                                ...
                                <div class="item mt-5">
                                    <div class="item-image" style="margin-right: 15px;">
                                        <a href="{{ route('shop.product.index', $item->product->url_key) }}"><img src="{{ $productBaseImage['medium_image_url'] }}" /></a>
                                    </div>
                                    ...
                                    <div class="item-details">
                                        ...
                                        <div class="item-title">
                                            <a href="{{ route('shop.product.index', $item->product->url_key) }}">
                                                {{ $item->product->name }}
                                            </a>
                                        </div>
        ...
        @else
            ...
            <div class="cart-content">
                ...
                <p style="display: inline-block;">
                    <a style="display: inline-block;" href="{{ route('shop.home.index') }}" class="btn btn-primary">{{ __('shop::app.checkout.cart.continue-shopping') }}</a>
                </p>
            </div>
