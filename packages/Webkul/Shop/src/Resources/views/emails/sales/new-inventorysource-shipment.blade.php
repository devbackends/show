    ...
    <div style="padding: 30px;">
        ...
        <div style="display: flex;flex-direction: row;margin-top: 20px;justify-content: space-between;margin-bottom: 40px;">
            <div style="line-height: 25px;">
                ...
                <div>
                    {{ $order->shipping_address->address1 }}<br />{{ $order->shipping_address->city }}, {{ $order->shipping_address->state }} {{ $order->shipping_address->postcode }}
                </div>
            ...
            <div style="line-height: 25px;">
                ...
                <div>
                    {{ $order->billing_address->address1 }}<br />{{ $order->billing_address->city }}, {{ $order->billing_address->state }} {{ $order->billing_address->postcode }}
                </div>
