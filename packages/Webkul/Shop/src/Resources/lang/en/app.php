...
return [
    ...
    'layouts' => [
        ...
        'wishlist' => 'Wishlist',
        'orders' => 'My Orders',
        'downloadable-products' => 'Product Downloads'
    ],
    ...
    'home' => [
        ...
        'featured-products' => 'Promoted Products',
    ...
    'products' => [
        ...
        'remove-filter-link-title' => 'Clear',
        'sort-by' => 'Sort By',
        'from-a-z' => 'From A-Z',
        'from-z-a' => 'From Z-A',
    ...
    'checkout' => [
        ...
        'onepage' => [
            ...
            'shipping-address' => 'Shipping Address',
            'use_for_shipping' => 'Ship to this address (not available for firearms)',
            'continue' => 'Continue',
        ...
        'success' => [
            ...
            'other-products' => 'There are additional items in your cart from other sellers.',
    ...
    'mail' => [
        'order' => [
            ...
            'help' => 'If you need any kind of help please contact :seller_name',
            'thanks' => 'Thanks!',
            'cancel' => [
        ...
        'shipment' => [
            ...
            'costumer_auto_message' => "Hello, I'm contacting you regarding my order #:order_id",
        ],
        ...
        'customer' => [
            'new' => [
                'dear' => 'Welcome to 2A Gun Show, :customer_name',
                'username-email' => 'UserName/Email',
                'subject' => 'New Customer Registration',
                'password' => 'Password',
                'summary' => 'Find exactly what you’re looking for, from the practical to kickass, right now!',
                'thanks' => 'Thanks!',
                'temporary-username' => 'Your temporary username is',
                'change' => 'You can change during your',
                'profile-setup' => 'profile setup',
                'latest' => 'Check out the latest products',
            ],
            ...
            'registration' => [
                ...
                'customer-registration' => 'Customer Registered Successfully',
                'dear' => 'Dear :customer_name',
                'greeting' => 'Welcome and thank for registering with 2A Gun Show!',
                'summary' => 'You can login using your email address and password credentials. Upon logging in, you can access other services including reviewing past orders, wishlists and editing your account information.',
                'thanks' => 'Thanks!',
                'login' => 'Login Now!',
                'buynow' => 'Check out the latest products!',
            ],

            'verification' => [
                'heading' => 'Please verify your email.',
                'hello' => config('app.name') . ' - Email Verification',
                'subject' => 'Verification Mail',
                'verify' => 'Click this link',
                'summary' => 'To verify your email and finish setting up your account,'
            ],
        ...
        'ffl' => [
            'help' => 'As always, we are here to help you grow and promote your shooting sports business, so don\'t hesitate to reach out via our support portal by emailing ',
            'congratulations' => 'Congratulations!',
            'approved' => 'You have been approved to be part of the 2A Gun Show preferred FFL network!',
            'business_priority' => 'We will begin giving your business priority for transfers in your area!',
            'whats_next' => 'SO WHAT\'S NEXT?',
            'start_setting_up' => 'Now it\'s time to start setting up your free seller profile to increase your web and in-store foot traffic, or promote your next training course with our 2A.Academy engine. Here are the benefits of your seller profile:',
            'sell_and_promote' => 'Sell and Promote products to our community – we do all the marketing for you.',
            'manage_trainings' => 'List and manage your training courses through our 2A.Academy instructor network.',
            'host_an_event' => 'Host an event such as a Gun Show or a special meetup at your range or store.',
        ],
    ],
