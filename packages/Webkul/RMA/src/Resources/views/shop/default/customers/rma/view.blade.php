...
@push('scripts')
    <script type="text/x-template" id="options-template">
        <div>
            <div class="sale-section" @if($rmaData['status'] == 1 || $rmaData['rma_status'] == 'Declined') style="display:none;" @endif>
                <div class="secton-title">
                    <span>
                        {{ __('rma::app.shop.view-customer-rma.close-rma') }}
                    </span>
                    ...
                    @if ($show)
                        <div class="row">
                            <form method="POST" id="form-1"  data-vv-scope="form-1" @submit.prevent="validateForm('form-1')"
                                ...
                                <button type="submit" class="btn btn-primary" name="form-1">
                            ...
                            <span class="title">
                                ...
                                <strong>
                                    ...
                                    @elseif ($message->is_admin == 0)
                                        {{ __('rma::app.shop.conversation-texts.customer') }}
                ...
                <div class="section-content">
                        ...
                        <form  data-vv-scope="form-2" id="form-2" method="POST" @submit.prevent="validateForm('form-2')"
                            ...
                            <div class="control-group" :class="[errors.has('form-2.message') ? 'has-error' : '']">
                                ...
                                <button type="submit" class="btn btn-primary" name="form-2" style="margin-top:7px;">
