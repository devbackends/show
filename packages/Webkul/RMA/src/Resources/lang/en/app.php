...
return [
    'shop' => [
        ...
        'customer-rma-index' => [
            'create' => 'Request new Return',
            'heading' => 'Customer Return Panel',
        ...
        'customer-rma-create' => [
            ...
            'rma-not-avilable-quotes' => 'Item not avilable for Return',
    ...
    'admin' => [
        ...
        'title' => [
            'index' => 'RMA',
            'reason-title' => 'RMA Reasons',
            'create' => 'Create RMA',
            'edit' => 'Edit RMA',
        ],
        'reasons' => [
            'heading' => 'Reasons',
            'create-btn' => 'Add New Reason',
        ],
        'table-heading' => [
            'id' => 'ID',
            'reason' => 'Reason',
        ...
        'rma-tab-name' => [
            ...
            'tab-content' => [
                ...
                'product-details' => 'Product Details',
                'rma' => 'RMA :id',
                'order-and-product' => 'Order and Product',
    ...
    'status' => [
        ...
        'status-quotes' => [
            ...
            'solved_by_admin' => 'RMA is solved by admin.',
        ],
    ],
    ...
    'response' => [
        ...
        'attribute-reason-error' => ':name is used in RMA.',
