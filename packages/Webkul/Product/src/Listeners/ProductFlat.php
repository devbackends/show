...
/*                                                                 ->where('channel', $channel->code)
                    ...
                    if(!isset($customer_id)){
                        $productFlat->marketplace_seller_id=0;
                    }else{
                        $productFlat->marketplace_seller_id= app('Webkul\Marketplace\Repositories\SellerRepository')->getVendorBySellerId($customer_id);
                    }
                    ...
                    if ($parentProduct) {
                        ...
                        if ($parentProductFlat) {
                            ...
                            $productFlat->url_key = $this->cleanUrl($product->sku);
                        }
                    }
                    $productFlat->save();
                }
