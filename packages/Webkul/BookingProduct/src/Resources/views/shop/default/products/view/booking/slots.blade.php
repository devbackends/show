            ...
            <div class="control-group-container">
                <div class="form-group date" :class="[errors.has('booking[date]') ? 'has-error' : '']">
                    <date @onChange="dateSelected($event)">
                        <input type="text" v-validate="'required'" name="booking[date]" class="form-control" data-vv-as="&quot;{{ __('bookingproduct::app.shop.products.date') }}&quot;"/>
                    </date>
                ...
                <div class="form-group slots" :class="[errors.has('booking[slot]') ? 'has-error' : '']">
                    <select v-validate="'required'" name="booking[slot]" class="form-control" data-vv-as="&quot;{{ __('bookingproduct::app.shop.products.slot') }}&quot;">
