<script type="text/x-template" id="slot-list-template">
    <div>
        <div class="slot-list" v-if="parseInt(sameSlotAllDays)">
        ...
        <div class="slot-list" v-else>
            <accordian
                ...
                <div slot="body">
                    ...
                    <button type="button" class="btn btn-primary" style="margin-top: 20px" @click="addSlot(dayIndex)">
                        {{ __('bookingproduct::app.admin.catalog.products.add-slot') }}
                    </button>
                </div>
            </accordian>
