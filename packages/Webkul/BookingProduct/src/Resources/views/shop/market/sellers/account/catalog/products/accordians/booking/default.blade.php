    ...
    <script type="text/x-template" id="default-booking-template">
        <div>
            <div class="form-group" :class="[errors.has('booking[booking_type]') ? 'has-error' : '']">
                ...
                <select v-validate="'required'" name="booking[booking_type]" v-model="default_booking.booking_type" class="form-control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.type') }}&quot;">
            ...
            <div v-if="default_booking.booking_type == 'many'">
                <div class="form-group" :class="[errors.has('booking[duration]') ? 'has-error' : '']">
                    ...
                    <input type="text" v-validate="'required|min_value:1'" name="booking[duration]" v-model="default_booking.duration" class="form-control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.slot-duration') }}&quot;"/>
                ...
                <div class="form-group" :class="[errors.has('booking[break_time]') ? 'has-error' : '']">
                    ...
                    <input type="text" v-validate="'required|min_value:1'" name="booking[break_time]" v-model="default_booking.break_time" class="form-control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.break-time') }}&quot;"/>
            ...
            <div class="section">
                ...
                <div class="section-content">
                    ...
                    <div class="slot-list" v-if="default_booking.booking_type == 'many'">
                                    ...
                                    <tr v-for="(day, index) in days">
                                        ...
                                        <td>
                                            <div class="form-group" :class="[errors.has('booking[slots][' + index + '][from]') ? 'has-error' : '']">
                                                <time-component>
                                                    <input type="text" v-validate="parseInt(slots.many[index].status) ? 'required': ''" :name="'booking[slots][' + index + '][from]'" class="form-control" v-model="slots.many[index].from" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.from') }}&quot;">
                                                </time-component>
                                        ...
                                        <td>
                                            <div class="form-group" :class="[errors.has('booking[slots][' + index + '][to]') ? 'has-error' : '']">
                                                <time-component>
                                                    <input type="text" v-validate="parseInt(slots.many[index].status) ? 'required': ''" :name="'booking[slots][' + index + '][to]'" class="form-control" v-model="slots.many[index].to" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.to') }}&quot;">
                                                </time-component>
                                        ...
                                        <td>
                                            <div class="form-group" :class="[errors.has('booking[slots][' + index + '][status]') ? 'has-error' : '']">
                                                <select v-validate="'required'" :name="'booking[slots][' + index + '][status]'" class="form-control" v-model="slots.many[index].status" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.status') }}&quot;">
                    ...
                    <div class="slot-list" v-if="default_booking.booking_type == 'one'">
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                        ...
                        <button type="button" class="btn btn-primary" style="margin-top: 20px" @click="addSlot()">
    ...
    <script type="text/x-template" id="default-slot-item-template">
        <tr>
            <td class="has-control-group">
                <div class="form-group date mb-3" :class="[errors.has(controlName + '[from_day]') ? 'has-error' : '']">
                    <select v-validate="'required'" :name="controlName + '[from_day]'" v-model="slotItem.from_day" class="form-control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.day') }}&quot;">
                ...
                <div class="form-group date" :class="[errors.has(controlName + '[from]') ? 'has-error' : '']">
                    <time-component>
                        <input type="text" v-validate="'required'" :name="controlName + '[from]'" v-model="slotItem.from" class="form-control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.from') }}&quot;">
                    </time-component>
            ...
            <td class="has-control-group">
                <div class="form-group date mb-3" :class="[errors.has(controlName + '[to_day]') ? 'has-error' : '']">
                    <select v-validate="'required'" :name="controlName + '[to_day]'" v-model="slotItem.to_day" class="form-control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.day') }}&quot;">
                        <option v-for="(day, index) in $parent.days" :value="index">@{{ day }}</option>
                    </select>
                ...
                <div class="form-group date" :class="[errors.has(controlName + '[to]') ? 'has-error' : '']">
                    <time-component>
                        <input type="text" v-validate="'required'" :name="controlName + '[to]'" v-model="slotItem.to" class="form-control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.to') }}&quot;">
                    </time-component>
