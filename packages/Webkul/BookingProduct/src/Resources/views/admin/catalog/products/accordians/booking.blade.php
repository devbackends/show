    ...
    <script type="text/x-template" id="booking-information-template">
        <div>
            <div class="row">
                <div class="col-12 col-md-4">
                    <div class="form-group" :class="[errors.has('booking[type]') ? 'has-error' : '']">
                        ...
                        <select v-validate="'required'" name="booking[type]" v-model="booking.type" class="form-control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.booking-type') }}&quot;">
                        ...
                        <span class="control-error text-danger" v-if="errors.has('booking[type]')">@{{ errors.first('booking[type]') }}</span>
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="form-group">
                        <label>{{ __('bookingproduct::app.admin.catalog.products.location') }}</label>
                        <input type="text" name="booking[location]" v-model="booking.location" class="form-control"/>
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="form-group" :class="[errors.has('booking[qty]') ? 'has-error' : '']" v-if="booking.type == 'default' || booking.type == 'appointment' || booking.type == 'rental'">
                        ...
                        <input type="text" v-validate="'required|numeric|min:0'" name="booking[qty]" v-model="booking.qty" class="form-control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.qty') }}&quot;"/>

                        <span class="control-error text-danger" v-if="errors.has('booking[qty]')">@{{ errors.first('booking[qty]') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group" v-if="booking.type != 'event' && booking.type != 'default'" :class="[errors.has('booking[available_every_week]') ? 'has-error' : '']">
                ...
                <select v-validate="'required'" name="booking[available_every_week]" v-model="booking.available_every_week" class="form-control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.available-every-week') }}&quot;">
                ...
                <span class="control-error text-danger" v-if="errors.has('booking[available_every_week]')">@{{ errors.first('booking[available_every_week]') }}</span>
            </div>

            <div v-if="! parseInt(booking.available_every_week)" class="row">
                <div class="col-12 col-md-4">
                    <div class="form-group date" :class="[errors.has('booking[available_from]') ? 'has-error' : '']">
                        ...
                        <datetime>
                            <input type="text" v-validate="'required|date_format:yyyy-MM-dd HH:mm:ss'" name="booking[available_from]" v-model="booking.available_from" class="form-control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.available-from') }}&quot;" ref="available_from"/>
                        </datetime>

                        <span class="control-error text-danger" v-if="errors.has('booking[available_from]')">@{{ errors.first('booking[available_from]') }}</span>
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="form-group date" :class="[errors.has('booking[available_to]') ? 'has-error' : '']">
                        ...
                        <datetime>
                            <input type="text" v-validate="'required|date_format:yyyy-MM-dd HH:mm:ss|after:available_from'" name="booking[available_to]" v-model="booking.available_to" class="form-control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.available-to') }}&quot;" ref="available_to"/>
                        </datetime>

                        <span class="control-error text-danger" v-if="errors.has('booking[available_to]')">@{{ errors.first('booking[available_to]') }}</span>
                    </div>
                </div>
            </div>
