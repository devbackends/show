...
@push('scripts')
    ...
    <script type="text/x-template" id="ticket-list-template">
        <div class="ticket-list">
            ...
            <button type="button" class="btn btn-primary" style="margin-top: 20px" @click="addTicket()">
    ...
    <script type="text/x-template" id="ticket-item-template">
        <tr>
            <td>
                <div class="form-group" :class="[errors.has(controlName + '[{{$locale}}][name]') ? 'has-error' : '']">
                    <input type="text" v-validate="'required'" :name="controlName + '[{{$locale}}][name]'" v-model="ticketItem.name" class="form-control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.name') }}&quot;">
            ...
            <td>
                <div class="form-group" :class="[errors.has(controlName + '[price]') ? 'has-error' : '']">
                    <input type="text" v-validate="'required'" :name="controlName + '[price]'" v-model="ticketItem.price" class="form-control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.price') }}&quot;">
            ...
            <td>
                <div class="form-group" :class="[errors.has(controlName + '[qty]') ? 'has-error' : '']">
                    <input type="text" v-validate="'required|min_value:0'" :name="controlName + '[qty]'" v-model="ticketItem.qty" class="form-control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.qty') }}&quot;">
            ...
            <td>
                <div class="form-group" :class="[errors.has(controlName + '[{{$locale}}][description]') ? 'has-error' : '']">
                    <textarea type="text" v-validate="'required'" :name="controlName + '[{{$locale}}][description]'" v-model="ticketItem.description" class="form-control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.description') }}&quot;"></textarea>
