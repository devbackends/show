...
@section('page_title')
    {{ __('tablerate::app.admin.shipping-rates.add-title') }}
@stop

@section('content')
    <div class="content">
        <form method="POST" action="{{ route ('admin.tablerate.shipping_rates.store') }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
            @csrf()
            ...
            <div class="page-content">
                <div class="form-container">
                    <accordian :title="'{{ __('tablerate::app.admin.shipping-rates.add-shipping-rate') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('tablerate_superset_id') ? 'has-error' : '']">
                                ...
                                <select class="control" v-validate="'required'" id="" name="tablerate_superset_id" data-vv-as="&quot;{{ __('tablerate::app.admin.superset-rates.superset-name') }}&quot;">
                                    ...
                                    @foreach($superSets as $method)
                                        <option value="{{ $method->id }}" @if(old('tablerate_superset_id') == $method->id) selected @endif>{{ $method->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="control-group" :class="[errors.has('weight_from') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" name="weight_from" value="{{ old('weight_from') }}" data-vv-as="&quot;{{ __('tablerate::app.admin.shipping-rates.weight-from') }}&quot;">
                            ...
                            <div class="control-group" :class="[errors.has('weight_to') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" name="weight_to" value="{{ old('weight_to') }}" data-vv-as="&quot;{{ __('tablerate::app.admin.shipping-rates.weight-to') }}&quot;">
                            ...
                            <div class="control-group" :class="[errors.has('zip_from') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" name="zip_from" value="{{ old('zip_from') }}" data-vv-as="&quot;{{ __('tablerate::app.admin.shipping-rates.zip-from') }}&quot;">
                            ...
                            <div class="control-group" :class="[errors.has('zip_to') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" name="zip_to" value="{{ old('zip_to') }}" data-vv-as="&quot;{{ __('tablerate::app.admin.shipping-rates.zip-to') }}&quot;">
                            ...
                            <div class="control-group" :class="[errors.has('price') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required|decimal:4|min_value:0'" class="control" name="price" value="{{ old('price') }}" data-vv-as="&quot;{{ __('tablerate::app.admin.shipping-rates.price') }}&quot;">
                            ...
                            <div class="control-group" :class="[errors.has('is_zip_range') ? 'has-error' : '']">
                                <label for="is_zip_range" class="required">{{ __('tablerate::app.admin.shipping-rates.is-range') }}</label>
                                ...
                                <select class="control" v-validate="'required'" id="is_zip_range" name="is_zip_range" data-vv-as="&quot;{{ __('tablerate::app.admin.shipping-rates.is_zip_range') }}&quot;">
                                    <option value="0" @if (old('is_zip_range') == 1) selected @endif>{{ __('tablerate::app.admin.shipping-rates.isrange-yes') }}</option>
                                    <option value="1" @if (old('is_zip_range') == 0) selected @endif>{{ __('tablerate::app.admin.shipping-rates.isrange-no') }}</option>
                                </select>
                            ...
                            <div class="control-group" :class="[errors.has('zip_code') ? 'has-error' : '']">
                                <label for="zip_code" class="required">{{ __('tablerate::app.admin.shipping-rates.zip-code') }}</label>
                                <input type="text" v-validate="'required'" class="control" name="zip_code" value="{{ old('zip_code') ?: '*' }}" data-vv-as="&quot;{{ __('tablerate::app.admin.shipping-rates.zip-code') }}&quot;">
