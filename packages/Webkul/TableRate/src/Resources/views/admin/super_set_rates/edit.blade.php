...
@section('page_title')
    {{ __('tablerate::app.admin.superset-rates.edit-title') }}
@stop

@section('content')
    <div class="content">
        <form method="POST" action="{{ route('admin.tablerate.superset_rates.update',$superSetRate->id) }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
                    ...
                    <accordian :title="'{{ __('tablerate::app.admin.superset-rates.details') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('price_from') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required|decimal:4'" class="control" name="price_from" value="{{ old('price_from') ?: $superSetRate->price_from }}" data-vv-as="&quot;{{ __('tablerate::app.admin.superset-rates.price-from') }}&quot;">
                            ...
                            <div class="control-group" :class="[errors.has('price_to') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required|decimal:4'" class="control" name="price_to" value="{{ old('price_to') ?: $superSetRate->price_to }}" data-vv-as="&quot;{{ __('tablerate::app.admin.superset-rates.price-to') }}&quot;">
                            ...
                            <div class="control-group" :class="[errors.has('shipping_type') ? 'has-error' : '']">
                                ...
                                <select class="control" v-validate="'required'" id="shipping_type" name="shipping_type" data-vv-as="&quot;{{ __('tablerate::app.admin.superset-rates.shipping-type') }}&quot;">
                                    <option value="Fixed" {{ $superSetRate->shipping_type == 'Fixed' ? 'selected' : '' }}>{{ __('tablerate::app.admin.superset-rates.fixed') }}</option>
                                    <option value="Free" {{ $superSetRate->shipping_type == 'Free' ? 'selected' : '' }}>{{ __('tablerate::app.admin.superset-rates.free') }}</option>
                                </select>
                            ...
                            <div class="control-group" :class="[errors.has('tablerate_superset_id') ? 'has-error' : '']">
                                ...
                                <select class="control" v-validate="'required'" id="" name="tablerate_superset_id" data-vv-as="&quot;{{ __('tablerate::app.admin.superset-rates.superset-name') }}&quot;">
                                    @foreach($superSets as $method)
                                        <option value="{{ $method->id }}" @if($superSetRate->tablerate_superset_id == $method->id) selected @endif>{{ $method->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="control-group" :class="[errors.has('price') ? 'has-error' : '']" id="get_pricediv">
                                ...
                                <input type="text" v-validate="'required|decimal:4|min_value:0'" id="get_price" class="control" name="price" value="{{ old('price') ?: $superSetRate->price }}" data-vv-as="&quot;{{ __('tablerate::app.admin.superset-rates.price') }}&quot;">
