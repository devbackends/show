...
@section('content')
    <div class="content">
        ...
        <form method="POST" id="page-form" action="{{ route('blog.admin.post_category.store') }}" enctype="multipart/form-data">
                    ...
                    <accordian :title="'{{ __('blog::app.general.general') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('title') ? 'has-error' : '']">
                                <label for="name" class="required">{{ __('blog::app.post_category.name') }}</label>
                                <input type="text" class="control"
                                       name="name"
                                       id="name"
                                       value="{{ old('name') }}"
                                       v-validate="'required'"
                                       data-vv-as="&quot;{{ __('blog::app.post_category.name') }}&quot;">
