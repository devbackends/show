...
@section('content-wrapper')
    <div class="auth-content">
        <div class="login-form">
            <div class="login-text">{{ __('megaPhoneLogin::app.customer.verify-phone.page-title') }}</div>
            <div  class="control-group" :class="[errors.has('phone') ? 'has-error' : '']">
                <label for="megaphone" class="required">{{ __('megaPhoneLogin::app.customer.signup-form.phone') }}</label>
                <input type="text" id="megaphone" class="control" name="phone" value="{{ $customer->phone }}" data-vv-as="{{ __('megaPhoneLogin::app.customer.signup-form.phone') }}">
                <div>
            ...
            <div  class="control-group">
                ...
                <input type="text" id="megaotp" class="control" name="verificationcode" data-vv-as="{{ __('megaPhoneLogin::app.customer.signup-form.popup.otp-label') }}">
