        ...
        <form method="POST" action="{{ route('customer.session.create') }}" @submit.prevent="onSubmit">
            ...
            <div class="login-form">
                ...
                <div class="control-group" :class="[errors.has('email') ? 'has-error' : '']">
                    <label for="email" class="required">{{ __('megaPhoneLogin::app.customer.login-form.email-phone') }}</label>
                    <input type="text" class="control" name="email" v-validate="'required'" value="{{ old('email') }}" data-vv-as="&quot;{{ __('megaPhoneLogin::app.customer.login-form.email-phone-err') }}&quot;">
